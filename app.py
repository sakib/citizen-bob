...
database = [CrimeReport(username="sagnew",crime="sus", time="04:20:00", x_location="3000", y_location="3000" )]
# minutes
...
def render_map():
    ...
    if len(database) > 0:
        ...
        crime_desc = crime.crime

    return render_template('map.jinja2', map_x=x, map_y=y, crime_description=crime_desc)
